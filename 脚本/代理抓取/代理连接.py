...
def 设置系统代理(代理_IP, 代理端口):
    if platform.system() == "Windows":
        try:
            ...
            print(f"已设置 WinHTTP 代理为 {代理_IP}:{代理端口}")
            ...
            if result.returncode == 0:
                ...
                print(f"查询 WinINET 代理设置时发生错误: {result.stderr}")
